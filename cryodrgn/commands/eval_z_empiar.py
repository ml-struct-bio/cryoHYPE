...
from cryodrgn import dataset_empiar as dataset
...
def add_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        type=os.path.abspath,
        metavar="PKL",
        help="published labels for EMPIAR-10076",
    )
    group.add_argument(
        "--uninvert-data",
        dest="invert_data",
...
def main(args):
    ...
    pub_labels = load_pkl(args.pub_labels)
    
    ind_orig = load_pkl(args.ind)
    pub_labels = pub_labels[ind_orig]
